...
# 定义输出 CSV 文件名
OUTPUT_CSV_PATH = 'data/raw/hand_landmarks_train_dir.csv'

# 定义图片所在的目录
IMAGE_DIR = 'data/train'  # 请替换为你的图片目录
    ...
    with mp_hands.Hands(
        ...
        for image_file in image_files:
            ...
            if results.multi_hand_landmarks:
                ...
                handedness_label = results.multi_handedness[0].classification[0].label if results.multi_handedness else 'unknown'
                row = [label, handedness_label]
