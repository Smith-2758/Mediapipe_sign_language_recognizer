...
model_path = 'model/svm_model/relative_normalized/hand_gesture_recognition_model_partial_normalized.pkl'
scaler_path = 'model/svm_model/relative_normalized/hand_gesture_recognition_scaler_partial_normalized.pkl'
label_encoder_path = 'model/svm_model/relative_normalized/hand_gesture_recognition_label_encoder_partial_normalized.pkl'
...
# 设置语速 (默认是200，数值越大语速越快，范围通常在50-400之间)
engine.setProperty('rate', 125)  # 可以根据需要调整数值
